...
\begin{consigna}{black}
El propósito de este proyecto es proveer un producto que pueda insertarse dentro de un sistema de audio HiFi, permitiendo sumar fuentes de audio alternativas a las mas populares como el reproductor de discos o la bandeja giradiscos.
